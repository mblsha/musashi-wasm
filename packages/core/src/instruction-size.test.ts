...
describe('disassembleDetailed().size', () => {
  it('returns correct sizes for common instructions', async () => {
    ...
    expect(sys.disassembleDetailed(0x810)?.size).toBe(4);
    ...
    expect(sys.disassembleDetailed(0x860)?.size).toBe(6);
